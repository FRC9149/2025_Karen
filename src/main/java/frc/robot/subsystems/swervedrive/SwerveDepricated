...
public class SwerveDepricated extends SubsystemBase
{
   ...
   */
  public SwerveDepricated(File directory)
  {
   ...
   */
  public SwerveDepricated(SwerveDriveConfiguration driveCfg, SwerveControllerConfiguration controllerCfg)
  {
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  {
    velocity.plus(new ChassisSpeeds(0, 0, 0));
